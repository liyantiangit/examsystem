<?php /*a:1:{s:60:"E:\www\thinkphp5.1\application\home\view\login\register.html";i:1572572237;}*/ ?>
<!doctype html>
          ...
          <div class="row">
            <div class="col col-login mx-auto">
                ...
                <div class="card-body p-6">
                  ...
                  <div class="form-group">
                    <label class="custom-control custom-checkbox">
                      ...
                      <span class="custom-control-label">同意 <a href="terms.html">注册协议</a></span>
                    </label>
                  </div>
              ...
              <div class="text-center text-muted">
                已经有帐号? <a href="<?php echo url('index'); ?>">登录</a>
              </div>
            </div>
          </div>
        </div>

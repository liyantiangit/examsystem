<?php /*a:1:{s:60:"E:\www\thinkphp5.1\application\home\view\fraction\index.html";i:1572577716;}*/ ?>
	<!doctype html>
    ...
    <div class="page">
      <div class="flex-fill">
        <div class="header py-4">
          <div class="container">
            <div class="d-flex">
              <a class="header-brand" href="<?php echo url('index/index'); ?>">
                <img src="/assets/home/images/logo.png" class="header-brand-img" alt="ExamSystem">
              </a>
            ...
            <div class="row align-items-center">
              <div class="col-lg order-lg-first">
                <ul class="nav nav-tabs border-0 flex-column flex-lg-row">
                  <li class="nav-item">
                    <a href="<?php echo url('index/index'); ?>" class="nav-link"><i class="fe fe-home"></i> 我的考试</a>
                  </li>
                  <li class="nav-item">
                  ...
                  <li class="nav-item dropdown">
                    <a href="<?php echo url('fraction/index'); ?>" class="nav-link active"><i class="fe fe-calendar"></i> 成绩查询</a>
                  </li>
                </ul>
              </div>
            </div>
                ...
                <div class="card">
                  <table class="table card-table table-vcenter">
                    <tr>
                      ...
                      <td class="text-right">
                        <span class="badge badge-success">答题详细</span>
                      </td>
                    </tr>
                    <tr>

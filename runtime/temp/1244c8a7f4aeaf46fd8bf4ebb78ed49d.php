...
<html>
    ...
    <div yne-bulb-block="paragraph">版权所有 (c) 2019，广州市互佳科技有限公司保留所有权利。</div>
    <div yne-bulb-block="paragraph">感谢您选择ExamSystem，ExamSystem专为公众号与小程序的运营管理系统</div>
    <div yne-bulb-block="paragraph">广州市互佳科技有限公司为ExamSystem产品的开发商，依法独立拥有ExamSystem产品著作权。ExamSystem官方网站网址为 https://www.gzhujia.com。</div>
    <div yne-bulb-block="paragraph">使用者：无论个人或组织、盈利与否、用途如何（包括以学习和研究为目的），均需仔细阅读本协议，在理解、同意、并遵守本协议的全部条款后，方可开始使用ExamSystem软件。</div>
    <div yne-bulb-block="paragraph">广州市互佳科技有限公司拥有对本授权协议的最终解释权。</div>
    ...
    <div yne-bulb-block="paragraph">2)    您可以在协议规定的约束和限制范围内修改 ExamSystem 源代码或界面风格以适应您的网站要求；</div>
    ...
    <div yne-bulb-block="paragraph">1)    无论如何，即无论用途如何、是否经过修改或美化、修改程度如何，只要使用ExamSystem的整体或任何部分，未经书面许可，页面页脚处的 Powered by ExamSystem名称和官网网站的链接（https://www.gzhujia.cn ）都必须保留，而不能清除或修改；</div>
    <div yne-bulb-block="paragraph">2)    禁止ExamSystem的整体或任何部分基础上以发展任何派生版本、修改版本或第三方版本用于重新分发；</div>
    ...
    <div yne-bulb-block="paragraph">3)    广州市互佳科技有限公司不对使用本软件构建的系统中的文章或信息承担责任。</div>
    <div yne-bulb-block="paragraph">有关ExamSystem最终用户授权协议、技术服务的详细内容，均由ExamSystem官方网站独家提供。广州市互佳科技有限公司拥有在不事先通知的情况下，修改授权协议和服务价目表的权力，修改后的协议或价目表对自改变之日起的新授权用户生效。</div>
